...
Page {
  ...
  AppFlickable {
    ...
    contentWidth: width
    contentHeight: Math.max(flick.height, content.height + demosArea.height)
        ...
        Rectangle {
          ...
          Column {
            ...
            Image {
              ...
              source: "../../assets/vplay-engine.png"
              width: dp(150)
        ...
        Rectangle {
          ...
          Column {
            ...
            AppText {
              ...
              text: "Choose V-Play as your <b>partner</b> and get:"
            }
        ...
        Rectangle {
          ...
          Column {
            ...
            AppText {
              ...
              font.pixelSize: sp(13)
              text: "Join V-Play customers like:"
              font.bold: true
            }
...
Save time and money by using the V-Play Engine."
      }
...
<li>And many more...</li>
      ...
      AppImage {
        ...
        source: "../../assets/vplay-plugins.png"
      }
  ...
  function confirmOpenUrl() {
    NativeDialog.confirm("Leave the app?","This action opens your browser to visit https://v-play.net/qtws17-free-intro/.",function(ok) {
      if(ok)
        nativeUtils.openUrl("https://v-play.net/qtws17-free-intro/")
    })
  }
}
