  ...
  AppFlickable {
    ...
    Column {
      ...
      Column {
        ...
        Rectangle {
          width: parent.width
          height: vplayBlockColumn.height
...
<li>And many more...</li>
  ...
  function confirmOpenUrl() {
    NativeDialog.confirm("Leave the app?","This action opens your browser to visit https://v-play.net/qws-conference-in-app-2017.",function(ok) {
      if(ok)
        nativeUtils.openUrl("https://v-play.net/qws-conference-in-app-2017")
    })
  }
